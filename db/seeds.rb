...
BaseballPlayer.create!(name:'岡本 和真', team:'トロント・ブルージェイズ', position:'一塁手', hometown:'奈良県')
BaseballPlayer.create!(name:'佐々木 朗希', team:'ロサンゼルス・エンジェルス', position:'投手', hometown:'岩手県')
